...
<div class="main">
 <form action="Show.jsp" method="POST" name="pers" id="pers">
 <div class="details">
   <table width="930" height="429" border="0" class="table">
     ...
     <tr>
       ...
       <td>&nbsp;</td>
       <td>Contract Due : </td>
       <td><input type="date" name="cdd" id="cdd" size="40"> </td>
     </tr>
     <tr>
       <td>Date of Birth : </td>
     ...
     <tr>
      ...
      <tr>
       <td>TEL :</td>
       <td><input type="text" name="tel" id="tel" size="40"></td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
     </tr>
     ...
     <tr>
       ...
       <td><input type="text" name="postadd" id="postadd" size="40"></td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
     </tr>
      <tr>
       <td>RES ADDRESS :</td>
       <td><input type="text" name="resadd" id="resadd" size="40" ></td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
     </tr>
